  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap:
          isActive
              ? () {
                // Using a simple fade transition instead of Hero animation
                Navigator.push(
                  context,
                  PageRouteBuilder(
                    pageBuilder:
                    ...
                    transitionsBuilder: (
                      ...
                      // Simple fade transition to avoid yellow line issues
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Icon(Icons.bookmark, color: Colors.amber[400], size: 14),
                      const SizedBox(width: 4),
                      Text(
